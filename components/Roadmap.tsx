...
const planets: PlanetProps[] = [
  ...
  },
  {
    ...
    phase: 'Phase 2',
    description: 'Automate attendance verification, challenge settlement, and support workflows.',
    glowColor: 'rgba(120, 190, 255, 0.35)',
  },
  {
    name: 'Multi-Campus Expansion',
    phase: 'Phase 3',
    description: 'Scale through ambassadors and partnerships while maintaining trust, fairness, and safety standards.',
  ...
  return (
    <div className="relative flex items-center gap-8 md:gap-16 py-12 md:py-20 group">
      ...
      <div className="relative z-10 flex items-center justify-center w-20 h-20 shrink-0">
        ...
        >
          <div className="absolute inset-0 rounded-full blur-xl transition-all duration-500 group-hover:blur-2xl" style={{ backgroundColor: planet.glowColor }} />
        </motion.div>
      </div>
    ...
    <section id="roadmap" className="py-32 px-6 relative overflow-hidden">
      <div className="max-w-4xl mx-auto relative">
        <div className="mb-8 text-center">
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-white">Roadmap</h2>
          <p className="text-gray-400 mt-3">A phased rollout focused on reliability, fairness, and measurable outcomes.</p>
        </div>
